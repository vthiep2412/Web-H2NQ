...
const Header: React.FC<HeaderProps> = ({ onHomeClick, onIntroClick, onFeatureClick, onAboutClick, onTechClick }) => {
        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2">
                <button className="text-slate-600 dark:text-slate-300 hover:text-[#379eff] px-3 py-2 rounded-md text-sm font-medium transition-colors">
                    Log In
                </button>
                <button className="bg-[#379eff] text-white text-sm font-semibold px-4 py-2 rounded-md hover:bg-opacity-90 transition">
                    Sign Up
                </button>
                <button 
                  onClick={toggleTheme} 
