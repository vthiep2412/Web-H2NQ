...
const WorkspaceNavbar = React.memo(({
  activeView,
  onViewChange,
  workspaces,
  addWorkspace,
  ...
  return (
    <nav className="workspace-navbar">
      <div className="workspace-navbar-brand-container d-flex justify-content-between align-items-center mb-2">
        <h4 className="workspace-navbar-brand">{t('workspaces')}</h4>
      ...
      <div className="workspace-navbar-bottom">
        <Nav className="flex-column">
          <Nav.Link 
            onClick={() => {
              toggleHistoryNavbar();
