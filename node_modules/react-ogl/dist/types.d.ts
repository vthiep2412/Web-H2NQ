...
type Filter<T, O> = T extends [] ? [] : T extends [infer H, ...infer R] ? H extends O ? Filter<R, O> : [H, ...Filter<R, O>] : T;
...
type OGLElementProps<T extends ConstructorRepresentation, P = InstanceType<T>> = Partial<Overwrite<P, ReactProps<P> & MathProps<P> & EventProps<P>>>;
export type OGLElement<T extends ConstructorRepresentation> = Mutable<Overwrite<OGLElementProps<T>, Omit<InstanceProps<InstanceType<T>>, 'object'>>>;
...
type UniformRepresentation = UniformValue | {
